...
let temperatureMessage: string = temperature > 30 ? "It's too hot outside!" : "It's not too hot outside."
...
let number = 7;
// Using ternary operator
let numberMessage: string = number > 30? `It's too high`: number > 20? `It's correct`: `number is small`;
